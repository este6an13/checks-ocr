BANK_CODES = ['produbanco', 'austro', 'banecuador',
              'guayaquil', 'internacional', 'pichincha']

BOXES = {'produbanco':{'ACCOUNT_NAME': (0.5, 0.12, 0.04, 0.6),
            ...
            'austro':{'ACCOUNT_NAME': (0.5, 0.05, 0.05, 0.65),
            ...
            'internacional':{'ACCOUNT_NAME': (0.4, 0.2, 0.05, 0.65),
            ...
            'pichincha':{'ACCOUNT_NAME': (0.5, 0.12, 0.04, 0.6),
...
COLUMNS_MAP = {'ACCOUNT_NUMBER': 'NUMERO-CUENTA',
                'ACCOUNT_NAME': 'NOMBRE-CUENTA',
                'CLIENT_NAME':'BENEFICIARIO',
                'CHECK_NUMBER':'CHEQUE',
                'AMOUNT':'VALOR',}

BANK_NAMES = {'produbanco':'PRODUBANCO',
...
CONFIDENCE_COLUMNS = ['FECHA', 'NUMERO-CUENTA', 'NOMBRE-CUENTA', 'BENEFICIARIO', 'CHEQUE', 'VALOR', 'CIUDAD']

COLUMNS = ['FECHA', 'BANCO', 'CIUDAD', 'NUMERO-CUENTA', 'NOMBRE-CUENTA', 'BENEFICIARIO', 'CHEQUE', 'VALOR', 'ID']
